...
function MinhaConta() {
    ...
    const onSubmitSenha = async (dados: SenhaForm) => {
        ...
        try {
            ...
            setErro("A senha atual está inválida. Tente novamente.");
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <>
                    ...
                    >
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                className={
                                    errors.confirmarNovaSenha && "input-error"
                                }
            ...
            />
            <AlertModal
                key={"minha-conta-mensagem"}
                isOpen={!!mensagem}
                message={mensagem}
                onCancel={() => setMensagem("")}
                onClose={() => setMensagem("")}
                onConfirm={() => setMensagem("")}
