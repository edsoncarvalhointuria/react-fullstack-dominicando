                ...
                >
                    ...
                    <div className="classe-modal__header">
                        <h2>
                            ...
                            {rotuloId ? "Editar Rótulo" : "Cadastrar Novo Rótulo"}
                        </h2>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="classe-modal__body">
                                <div className="classe-modal__input-group">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        {...register("nome", {
                                            required: "O nome do rótulo é obrigatório",
                                            minLength: {
                                                value: 3,
                                ...
                                <div className="classe-modal__inputs">
                                    <div className="classe-modal__input-group">
                                        <label htmlFor="idade-minima-rotulo">
                                            Idade Mínima
                                            {idade_maxima ? <span> *</span> : <i> (não obrigatório)</i>}
                                        </label>
                                        <input
                            ...
                            <div className="classe-modal__footer">
                                ...
                                <button type="submit" className="button-primary" disabled={isEnviando}>
                                    {rotuloId ? "Salvar Alterações" : "Criar Rótulo"}
                                </button>
                            </div>
                        </form>
                    </FormProvider>
